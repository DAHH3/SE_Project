...
//TESTED: ALL CLEAR BUT COULD STAND TO ADD A FEW MORE EXCEPTION CONDITIONS
...
public class NoDoubleBooking {
  ...
  public void testNoDoubleBooking() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Date:'])[1]/following::label[1]")).click();
